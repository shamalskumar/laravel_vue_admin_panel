...
const page = ref({ title: 'Add New User' });
...
const sendOTP = async () => {
    formOTPData.value.country_code = formData.value.country_code;
    formOTPData.value.mobile_no = formData.value.mobile_no;
    try {
        if (!token) {
            throw new Error('Authorization token is missing');
        }
                ...
                <v-row>
                    <v-col cols="12" lg="12">
                        <v-row>
                            ...
                            <v-col cols="12" md="6">
                                <v-label class="mb-2 font-weight-medium">T.I.N Number</v-label>
                                <v-text-field
                                    variant="outlined"
                                    color="primary"
                                    type="number"
                                    v-model="formData.personal_tin_no"
                                    :rules="[requiredRule]"
                                ></v-text-field>
                            </v-col>
                            ...
                            <v-col cols="12" md="6">
                                <v-label class="mb-2 font-weight-medium">Source of Income</v-label>
                                <v-select
                                    v-model="formData.source_of_income_id"
                                    :items="incomeSources"
                                    item-value="id"
                                    item-title="source"
                                    :rules="[requiredRule]"
                            ...
                            <v-col v-if="showOTPSentAlert" cols="12" md="12">
                                <v-alert v-if="OTPSent" type="success" variant="tonal" class="mb-4">
                                    ...
                                    <div>OTP sent successfully to {{ formOTPData.mobile_no }}. Enter OTP value below.</div>
                                </v-alert>
                            </v-col>
                        ...
                        <v-btn v-if="OTPSent" color="primary" @click="submitForm">Add User</v-btn>
                    </v-col>
                </v-row>
            </UiParentCard>
        </v-col>

...
const page = ref({ title: 'Followers' });
                    ...
                    <v-card elevation="10">
                        <v-card-text>
                            <div class="d-flex align-center gap-3">
                                ...
                                <div class="ml-auto">
                                    <v-btn v-if="card.follow == 1" variant="flat" color="primary"> Followed</v-btn>
                                    <v-btn v-else variant="outlined" color="primary"> Follow</v-btn>
                                </div>
                            </div>
                        </v-card-text>
                    </v-card>

...
<template>
    <div class="d-flex flex-wrap align-center gap-3">
        <v-chip class="text-body-2"> <MoodSmileIcon class="mr-2" start size="20" /> Default Filled </v-chip>
        ...
        <v-chip color="secondary" class="text-body-2"> <MoodSmileIcon class="mr-2" start size="20" /> Secondary Filled </v-chip>
        ...
        <v-chip color="warning" class="text-body-2"> <MoodSmileIcon class="mr-2" start size="20" /> Default Filled </v-chip>

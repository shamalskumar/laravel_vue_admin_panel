...
<template>
    <div class="text-center">
        <v-btn color="secondary" class="w-100" @click="dialog = true" flat> Open Dialog 1 </v-btn>
        <v-dialog v-model="dialog" class="dialog-mw">
            <v-card class="pa-6">
                <v-card-title> Dialog 1 </v-card-title>
                <v-card-text>
                    <v-btn color="primary" class="" @click="dialog2 = true" flat> Open Dialog 2 </v-btn>
                </v-card-text>
                <v-card-actions>
        ...
        <v-dialog v-model="dialog2" class="dialog-mw">
            <v-card class="pa-6">
                ...
                <v-card-text>
                    <v-btn color="secondary" @click="dialog3 = !dialog3" flat> Open Dialog 3 </v-btn>
                </v-card-text>
                <v-card-actions>

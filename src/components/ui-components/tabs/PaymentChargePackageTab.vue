...
import PaymentChargeCrudTable from '@/views/tables/datatables/UserDetailsTransferLimitTable.vue';
...
<template>
    <v-card elevation="0">
        <v-tabs v-model="tab" color="primary" align-tabs="center">
            ...
            <v-tab value="2">Payment Charge Package</v-tab>

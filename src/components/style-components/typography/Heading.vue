...
const subtext = ref([
    [
        ...
        'font size: 15 | line-height: 17.6 | font weight: 400'
    ],
    [
        'Subtitle 2.',
        'text-subtitle-2',
        ' Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quos blanditiis tenetur',
        'font size: 13 | line-height: 16 | font weight: 400'
    ],
    [
        'Body 1.',
        'text-body-1',
        ' Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quos blanditiis tenetur',
        'font size: 14 | line-height: 24 | font weight: 400'
    ],
    [
        'Body 2.',
        'text-body-2',
        ' Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quos blanditiis tenetur',
        'font size: 12 | line-height: 24 | font weight: 400'
    ],
    [
        'Caption.',
        'text-caption',

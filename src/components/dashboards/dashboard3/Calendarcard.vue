...
import { TextColorIcon } from 'vue-tabler-icons';
...
export const INITIAL_EVENTS = [
    ...
    },
    {
        ...
        start: new Date(y, m, 19, 0),
        end: new Date(y, m, 21, 0),
        color: 'rgba(var(--v-theme-primary))'
    }
];
...
<template>
    <v-card elevation="10" class="overflow-hidden app-calendar">
        <v-card-item>
            <div class="demo-app">
                <div class="demo-app-main">
                    <FullCalendar class="demo-app-calendar rounded-md" :options="calendarOptions">
                        <template v-slot:eventContent="arg">
                            <div class="text-subtitle-1 text-truncate">{{ arg.event.title }}</div>
                        </template>
                    </FullCalendar>
                    <v-dialog v-model="updateModalShow" max-width="500px">
                        <v-card>
                            <v-card-text>
                                ...
                                <p class="text-subtitle-1 textSecondary my-4">

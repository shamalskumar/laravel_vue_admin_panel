...
<template>
    <v-card elevation="10" class="overflow-hidden">
        ...
        <v-card-item class="pt-6">
            ...
            <p class="text-15 text-muted my-3">Nullam lobortis sodales dolor vitae viverra. Cras lacinia bibendum metus vel rhoncus.</p>
            <div class="d-flex justify-content-start mt-4">
                <div class="ml-2 d-flex">
                    ...
                    <v-avatar size="40" class="ml-n2 avtar-border text-primary font-weight-medium" color="lightprimary"> +12 </v-avatar>
                </div>
            </div>
        </v-card-item>
    </v-card>

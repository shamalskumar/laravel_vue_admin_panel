    ...
    <Form>
        <v-row>
            <v-col cols="12">
                ...
                <v-text-field v-model="email" :rules="[rules.required, rules.email]" variant="outlined" hide-details="auto"></v-text-field>
            </v-col>
            <v-col cols="12">
            ...
            <v-col cols="12">
                <div class="d-flex justify-sm-end"><v-btn type="submit" class="submit-btn mt-2" flat color="primary">Submit</v-btn></div>
            </v-col>
        </v-row>
    </Form>
</template>

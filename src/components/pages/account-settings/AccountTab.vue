            ...
            <v-col cols="12" sm="6">
                <v-card variant="outlined">
                    <v-card-item>
                        ...
                        <div class="text-subtitle-1 textSecondary mt-2">Change your profile picture from here</div>
                        ...
                        <div class="text-subtitle-1 textSecondary text-center my-sm-8 my-6">Allowed JPG, GIF or PNG. Max size of 800K</div>
                    </v-card-item>
                </v-card>
            </v-col>
            <v-col cols="12" sm="6">
                <v-card variant="outlined">
                    <v-card-item>
                        ...
                        <div class="text-subtitle-1 textSecondary mt-2">To change your password please confirm here</div>
                        <div class="mt-5">
            ...
            <v-col cols="12">
                <v-card variant="outlined">
                    <v-card-item>
                        ...
                        <div class="text-subtitle-1 textSecondary mt-2">To change your personal detail , edit and save from here</div>
                        <div class="mt-5">
                            <v-row>
                                <v-col cols="12" md="6">
                                    <v-label class="mb-2 font-weight-medium">Your Name</v-label>
                                    <v-text-field color="primary" variant="outlined" type="text" v-model="namemodel" hide-details />
                                </v-col>
                                <v-col cols="12" md="6">

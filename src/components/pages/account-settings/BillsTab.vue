                    ...
                    <div class="mt-6">
                        <v-row>
                            <v-col cols="12" md="6">
                                ...
                                <v-text-field color="primary" variant="outlined" type="text" v-model="businessname" hide-details />
                            </v-col>
                            <v-col cols="12" md="6">
                                <v-label class="mb-2 font-weight-medium">Business Sector*</v-label>
                                <v-text-field color="primary" variant="outlined" type="text" v-model="businesssector" hide-details />
                            </v-col>
                            <v-col cols="12" md="6">
                            ...
                            <v-col cols="12" md="6">
                                ...
                                <v-text-field color="primary" variant="outlined" type="text" v-model="billingcountry" hide-details />
                            </v-col>
                            <v-col cols="12" md="6">
            ...
            <v-card variant="outlined">
                <v-card-item>
                    ...
                    <div class="d-flex align-center mt-7">
                        ...
                        <div class="pl-4">
                            <h5 class="text-subtitle-1 textSecondary mb-1">Current Plan</h5>
        ...
        <v-col cols="12" md="9">
            <v-card variant="outlined">
                <v-card-item>
                    ...
                    <div class="text-subtitle-1 textSecondary text-10 my-3">On 26 December, 2023</div>
                    <div class="d-flex align-center mt-7">
                        <v-avatar size="48" class="mr-2" rounded="md" color="lightprimary">
                    ...
                    <div class="mt-4">
                        <div class="text-subtitle-1 textSecondary text-10 mb-3">
                            If you updated your payment method, it will only be dislpayed here after your next billing cycle.
                        </div>
                        <v-btn class="text-error" variant="tonal" flat>Cancel Subscription</v-btn>
                    </div>
                </v-card-item>
            </v-card>
        </v-col>

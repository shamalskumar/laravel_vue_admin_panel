        ...
        <v-col cols="12">
            <v-card elevation="10" rounded="md">
                <v-img :src="post.coverImg" height="440" cover class="rounded-t-md align-end text-right">
                    <v-card-item
                        ><v-chip class="bg-surface text-body-2 font-weight-medium" rounded="sm" size="small" v-text="post.view"></v-chip
                    ></v-card-item>
                </v-img>
                ...
                <v-card-item class="pt-4">
                    <v-chip class="text-body-2 font-weight-medium bg-light" rounded="sm" size="small" v-text="post.category"></v-chip>
                    ...
                    <div class="d-flex align-center justify-space-between">
                        <div>
                            ...
                            <span class="text-subtitle-1 ml-2 textSecondary" v-text="post.view"></span>
                            <v-avatar class="ml-4" size="18">
                                <Message2Icon size="18" class="text-textPrimary" />
                            </v-avatar>
                            <span class="text-subtitle-1 ml-2 textSecondary" v-text="post.comments?.length"></span>
                        </div>
                        <div v-if="post.createdAt">
                            <v-avatar size="10">
                                <CircleIcon size="10" class="text-textPrimary" />
                            </v-avatar>
                            <span class="text-subtitle-2 ml-2 textSecondary" v-text="format(new Date(post.createdAt), 'E, MMM d')"></span>
                        </div>
                    </div>
                </v-card-item>
                <v-divider></v-divider>
                <div class="pa-6">
                    ...
                    <p class="my-4 text-body-1 textSecondary">
                    ...
                    <p class="text-subtitle-1 font-weight-bold">This is strong text.</p>
                    <p class="text-subtitle-1 font-italic textSecondary">This is italic text.</p>
                    <v-divider class="my-8"></v-divider>
                    <h3 class="text-h3">Unorder list.</h3>
                    <ul class="ml-10 mt-3">
                        <li class="text-body-1 textSecondary">Gigure out what it is or</li>
                        <li class="text-body-1 textSecondary">The links it currently</li>
                        <li class="text-body-1 textSecondary">It allows you to start your bid</li>
                        <li class="text-body-1 textSecondary">Gigure out what it is or</li>
                        <li class="text-body-1 textSecondary">The links it currently</li>
                        <li class="text-body-1 textSecondary">It allows you to start your bid</li>
                    </ul>
                    ...
                    <div class="d-flex mt-8 font-weight-bold ml-4 bg-grey100 py-5 px-4 rounded-md border-s-md border-primary text-h6">

        ...
        <v-card elevation="10" rounded="md" class="card-hover">
            <div>
                ...
                <v-card-item class="px-6 pt-4">
                    <v-chip class="text-body-2 font-weight-medium bg-light" size="small" rounded="sm" v-text="post?.category"></v-chip>
                    <h5 class="text-h5 text-13 my-6 custom-text-primary">
                        <RouterLink class="text-decoration-none color-inherits custom-title" :to="linkTo">{{ post?.title }}</RouterLink>
                    </h5>

...
<template>
    <div v-if="getCart.length > 0">
        ...
        <v-table class="revenue-table">
            <thead>
                <tr>
                    <th class="text-left text-h6 font-weight-semibold">Product</th>
                    <th class="text-left text-h6 font-weight-semibold">Price</th>
                    <th class="text-left text-h6 font-weight-semibold">Quantity</th>
                    <th class="text-left text-h6 font-weight-semibold">Total</th>
                ...
                <tr v-for="item in getCart" :key="item.name">
                    ...
                    <td class="product-details">
                        <v-btn-toggle variant="outlined" divided color="success">
                            ...
                            <v-btn size="x-small" class="text-subtitle-1 font-weight-semibold">
                                {{ item.qty }}
                            </v-btn>

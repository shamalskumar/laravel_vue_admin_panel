        ...
        <v-card-text>
            ...
            <v-row class="d-flex flex-cols gap-3">
                <v-col cols="12">
                    ...
                    <VTextField type="text" value="Sample product" placeholder="Product Name" variant="outlined" hide-details></VTextField>
                ...
                <v-col cols="12">
                        ...
                        <v-menu open-on-hover location="top">
                            <template v-slot:activator="{ props }">
                                <RouterLink to="#" v-bind="props" class="textSecondary" icon>
                                    <Icon icon="solar:info-circle-bold-duotone" height="15" />
                                </RouterLink>
                            </template>
                            <v-sheet rounded="sm" width="180" class="pa-4 text-center" elevation-10>
                    ...
                    <div v-if="discount == 'percent'">
                        ...
                        <v-row class="mt-6">
                            ...
                            <v-col cols="12" md="6" class="pt-0">
                                <v-label class="font-weight-medium mb-2">VAT Amountb (%) <span class="text-error ms-1">*</span></v-label>

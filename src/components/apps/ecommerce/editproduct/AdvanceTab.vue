        ...
        <v-card-text>
            ...
            <v-row>
                ...
                <v-col cols="12">
                    ...
                    <VTextField type="text" value="45874521458" placeholder="Barcode Number" variant="outlined" hide-details></VTextField>
                    ...
                    <v-row>
                        ...
                        <v-col cols="2" class="pb-0">
                            <v-btn variant="tonal" flat size="large" class="px-0 py-0" color="error" min-width="50"
                                ><Icon icon="material-symbols:close-small-rounded" height="25" />
                            </v-btn>
                        </v-col>
                        <v-col cols="12">
        ...
        <v-card-text>
            ...
            <v-row>
                <v-col cols="12" class="mb-3 mt-3">
                    ...
                    <VTextField type="text" value="sample product" placeholder="Meta tag name" variant="outlined" hide-details></VTextField>

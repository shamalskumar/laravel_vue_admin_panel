...
<template>
    <v-card variant="outlined" class="rounded card-hover overflow-hidden">
        <RouterLink :to="`/ecommerce/product/detail/${goto}`" class="overflow-hidden d-block lh-0">
            <img alt="product" :src="image" class="w-100 h-100" />
        </RouterLink>
        ...
        <v-card-item class="pa-6 pt-1">
            ...
            <div class="d-flex align-center justify-space-between mt-2">
                ...
                <v-rating color="warning" half-increments size="small" density="compact" v-model="rate"> </v-rating>
            </div>
        </v-card-item>

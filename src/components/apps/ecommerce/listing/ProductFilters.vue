...
<template>
    <v-sheet class="pa-4 pt-1 shop-sidebar">
        <v-expansion-panels v-model="panel" multiple>
            ...
            <v-divider />
            <v-expansion-panel elevation="0">
                <v-expansion-panel-title class="font-weight-semibold custom-accordion"> By Gender </v-expansion-panel-title>
                <v-expansion-panel-text class="acco-body">
            ...
            <v-divider />
            <v-expansion-panel elevation="0">
                <v-expansion-panel-title class="font-weight-semibold custom-accordion"> By Colors </v-expansion-panel-title>
                <v-expansion-panel-text class="acco-body">
            ...
            <v-divider />
            <v-expansion-panel elevation="0">
                <v-expansion-panel-title class="font-weight-semibold custom-accordion"> By Rating </v-expansion-panel-title>
                <v-expansion-panel-text class="acco-body">
                    <v-rating hover color="warning" v-model="selectRating" class="ma-2" density="compact"></v-rating>
                </v-expansion-panel-text>
            </v-expansion-panel>
        </v-expansion-panels>
        <v-btn color="primary" variant="flat" @click="filterReset()" block class="mt-5">Reset Filters</v-btn>
    </v-sheet>
</template>
<style lang="scss">
.custom-accordion {

            ...
            <v-col lg="6" sm="12" class="pl-lg-5 product-details">
                <div>
                    <div class="d-flex align-center gap-2">
                        <v-chip color="success" variant="elevated" size="small" elevation="0" rounded="sm" v-if="getProduct.isStock">
                            In Stock
                        </v-chip>
                ...
                <div class="mt-8">
                    ...
                    <RouterLink to="/" class="text-subtitle-1 text-decoration-none text-textPrimary"
